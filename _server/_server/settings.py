...
CSRF_TRUSTED_ORIGINS = os.getenv("CSRF_TRUSTED_ORIGINS", "http://10.0.0.197:8080,http://localhost:8080,http://127.0.0.1:8080,http://localhost:8000,http://127.0.0.1:8000").split(",")
